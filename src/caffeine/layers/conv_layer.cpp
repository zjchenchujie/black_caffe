...
void ConvolutionLayer<Dtype>::SetUp(const vector<caffeine::Blob<Dtype> *> &bottom, vector<caffeine::Blob<Dtype> *> *top) {
...
template <typename Dtype>
void ConvolutionLayer<Dtype>::Forward_cpu(const vector<caffeine::Blob<Dtype> *> &bottom,
